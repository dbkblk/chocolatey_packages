...
$packageName= 'homebank' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://homebank.free.fr/public/HomeBank-5.0.6-setup.exe' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'Homebank' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = '24A5F46B1309D1B1BD2FB31317798875'
...
#Install-ChocolateyPackage $packageName $fileType $silentArgs $url -checksum $checksum
